...
declare_id!("HAVdVRHKAespUhaBAKHuEh8ZHuM2SBiRXNFoibL6LcYi"); //This macro defines the address of our program once it is deployed, either localnet, devnet, or mainnet.

const ANCHOR_MINT_ADDRESS: &str = "EytvUW7adN852UvLebwv3MyB7EGmujdxHzxui2281SJU";
